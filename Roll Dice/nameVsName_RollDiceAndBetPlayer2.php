<?php
	...
	$_SESSION['FirstDiceOfPlayer1'] = $_POST['FirstDiceOfPlayer1'];
	$_SESSION['SecondDiceOfPlayer1'] = $_POST['SecondDiceOfPlayer1'];
	$_SESSION['betPlayer1'] = $_POST['betPlayer1'];
...
<html>
	...
	<body>
		...
		<div class='secondMenu'>
			...
			<form method="post" action="nameVsName_Result.php">
				<h2>Kostka 1: <input type='number' min='1' max='6' name='FirstDiceOfPlayer2' value='1'></h2>
				<h2>Kostka 2: <input type='number' min='1' max='6' name='SecondDiceOfPlayer2' value='1'></h2>
				<h2>Zakład:	<input type='number' min='2' max='1000' name='betPlayer2' value='2'></h2>
